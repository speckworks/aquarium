...
f1 = Fish.create(kind:"tetra", quantity:4, alive:true)
f2 = Fish.create(kind:"guppies", quantity:100, alive:true)
f3 = Fish.create(kind:"turtle", quantity:2, alive:true)
f4 = Fish.create(kind:"tetra", quantity:4, alive:true)
